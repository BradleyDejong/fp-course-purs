...
lift2 ::
  ...
  f b ->
  f c
lift2 f fa fb = unsafeCoerce fb -- error "todo: Course.Applicative#lift2"
...
lift4 ::
  ...
  f d ->
  f e
lift4 f fa fb fc fd = unsafeCoerce fd -- error "todo: Course.Applicative#lift4"
...
lift1 ::
  ...
  f a ->
  f b
lift1 f a = unsafeCoerce a -- pure $ error "todo: Course.Applicative#lift1"
